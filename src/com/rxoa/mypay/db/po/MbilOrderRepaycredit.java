...
/**
 * mbil_order_repaycredit 实体类
 * Tue Apr 05 11:23:28 CST 2016 baiyu
 */ 

@Entity(name="MbilOrderRepaycredit")
@Table(name="mbil_order_repaycredit")
@DynamicInsert
@DynamicUpdate

public class MbilOrderRepaycredit extends AbstractEntity{
	...
	@Column(name="od_isgimgid")
	private String odIsgimgid;
	@Column(name="od_stat")
	...
	public void setOdIsgimgid(String odIsgimgid){
		this.odIsgimgid=odIsgimgid;
	}
	public String getOdIsgimgid(){
		return odIsgimgid;
	}
