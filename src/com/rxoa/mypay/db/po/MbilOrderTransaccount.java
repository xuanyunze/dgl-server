...
/**
 * mbil_order_transaccount 实体类
 * Tue Apr 05 11:23:28 CST 2016 baiyu
 */ 

@Entity(name="MbilOrderTransaccount")
@Table(name="mbil_order_transaccount")
@DynamicInsert
@DynamicUpdate

public class MbilOrderTransaccount extends AbstractEntity{
