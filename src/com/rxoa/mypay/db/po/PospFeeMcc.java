...
@Entity(name="PospFeeMcc")
@Table(name="posp_fee_mcc")
@DynamicInsert
@DynamicUpdate

public class PospFeeMcc extends AbstractEntity{
	...
	@Column(name="mcc_feecode")
	private String mccFeecode;
	...
	public void setMccFeecode(String mccFeecode){
		this.mccFeecode=mccFeecode;
	}
	public String getMccFeecode(){
		return mccFeecode;
	}
