...
<%@ page import="com.rxoa.mypay.db.po.MbilCard" %>
...
<table border=0 cellpadding=0 cellspacing=0 width=1455 style='border-collapse:
 ...
 <tr height=15 style='height:15.0pt'>
  ...
  <td class=xl66 width=89 style='width:89pt'>当前户名</td>
  <td class=xl65 width=118 style='width:118pt'>当前银行账号</td>
  <td class=xl65 width=120 style='width:120pt'>当前开户支行</td>
  <td class=xl65 width=60 style='width:60pt'>当前联行号</td>
 </tr>
<%
 	...
 	while(it.hasNext()){
 		...
 		MbilCard card = (MbilCard)obj.get("card");
 %>
 <tr height=15 style='height:15.0pt'>
  ...
  <td class=xl65>清算失败</td>
  <td class=xl68><%=card.getCdAccname()%></td>
  <td class=xl68><%=card.getCdAccno()%></td>
  <td class=xl68><%=card.getCdBankbranch()%></td>
  <td class=xl68><%=card.getCdBankcode()%></td>
 </tr>
 <%
 	}
 %>
