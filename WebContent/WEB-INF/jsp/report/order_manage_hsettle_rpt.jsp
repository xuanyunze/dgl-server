...
<table border=0 cellpadding=0 cellspacing=0 width=1455 style='border-collapse:
 ...
 width:120pt'>
 <col class=xl65 width=60 style='mso-width-source:userset;mso-width-alt:4560;
 width:60pt'>
 <col width=316 style='mso-width-source:userset;mso-width-alt:6482;width:316pt'>
 <col width=316 style='mso-width-source:userset;mso-width-alt:6482;width:316pt'>
 ...
 <tr height=15 style='height:15.0pt'>
  ...
  <td class=xl65 width=120 style='width:120pt'>开户分行</td>
  <td class=xl65 width=120 style='width:120pt'>开户支行</td>
  <td class=xl65 width=120 style='width:120pt'>联行号</td>
  <td class=xl65 width=65 style='width:65pt'>清分方式</td>
 </tr>
<%
 ...
 <tr height=15 style='height:15.0pt'>
  ...
  <td class=xl68><%=settle.getSlStbankdistr()%></td>
  <td class=xl68><%=settle.getSlStbankbranch()%></td>
