	...
	<form id="dlgform">
	 ...
	 <tr>
	   ...
	   <td class="tdContent" style="padding-bottom:5px;">
	   	【为保证操作稳定，建议每次操作个数不要超过200个～】
	   </td>
	  </tr>
	  <tr>
	   <td class="tdLabel" width="15%">操作方式：</td>
	   <td class="tdContent" width="85%" style="color:#CCC;" nowrap>
	    <input type="radio" name="inType" value="1" checked style="width:20px;border:0;background:none;"/>登记新设备
	    <input type="radio" name="inType" value="2" style="width:20px;border:none;"/>分配设备[对未绑定设备重新分配机构]
	    <input type="radio" name="inType" value="3" style="width:20px;border:none;"/>重置设备[设备重置为未绑定状态]
	   </td>
	  </tr>
	  <tr>
