...
<script type="text/javascript">
	...
	pageinfo.pageUrl = "/<%=WebConfig.getProperty("web.path")%>/wf/realname/undeal/page.json/all";
	pageinfo.styleJson = "{'pStyle':{'tableStyle':{'tableCol':["
		...
		+"]}}}";
	pageinfo.crumbString = "流程管理,实名审核";
</script>
...
function fnDeleteItem(itemid){
	if(confirm("要删除该条数据吗?")){
		$.ajax({
        	type : "POST", 
 			url : "/"+basepath+"/wf/realname/undeal/del.json/manage/"+itemid,
			data : "",
			dataType: "json", 
