...
<script type="text/javascript">
	...
	pageinfo.pageUrl = "/<%=WebConfig.getProperty("web.path")%>/wf/bindothercard/dealed/page.json/all";
...
function fnShowItem(itemid){
	fnCreateShowDlg(
		"self","dialog-form","查看认证记录",
		"/"+basepath+"/wf/bindothercard/dealed/show/normal/"+itemid
	);
}
