...
<script type="text/javascript">
	...
	pageinfo.pageUrl = "/<%=WebConfig.getProperty("web.path")%>/order/receivemoney/${ordertype}/page.json/service";
...
function fnShowItem(itemid){
	fnCreateShowDlg(
		...
		"/"+basepath+"/order/receivemoney/${ordertype}/show/service/"+itemid
	);
}
