...
<body style="margin:0 auto;overflow-y:hidden;">
 <div style="display:none;" id="dialog" title="basic dialog"><p>这是一个采用默认样式的对话框</p></div>
 <!-- 页面框架主体 -->
 <div id="divmain" style="overflow-y:hidden;width:100%;height:100%;">
 <!-- 顶部信息区 -->
  <div id="divtop" style="position:absolute;top:0;left:0;">
   <div id="logo">
  ...
  <div id="divmiddle">
   <!-- 左侧导航区 -->
   <div id="divleft" style="overflow-x:auto;overflow-y:hidden;">
   	<div id="divlefttree">
   ...
   <!-- 右侧主体区 -->
   <div id="divright">
	<div id="divrighttab"></div>
	<div id="divrightwindow">
	 <div id="win1" class="divrightwin">
	 </div>
	 <div id="win2">
	 </div>
	</div>
  ...
  <!-- 底部信息区 -->
  <div id="divbottom" style="position:absolute;bottom:0px;left:0;height:26px;">&nbsp;</div>
