...
<script type="text/javascript">
	...
	pageinfo.pageUrl = "/<%=WebConfig.getProperty("web.path")%>/channel/page.json/all";
	pageinfo.styleJson = "{'pStyle':{'tableStyle':{'tableCol':["
		+"{'colName':'chlId','colText':'渠道ID','colWidth':'100px;','linkStat':'0','orderStat':'0'},"
		+"{'colName':'chlName','colText':'渠道名称','colWidth':'150px;','linkStat':'0','orderStat':'0'},"
		+"{'colName':'chlIp','colText':'接口地址','colWidth':'150px;','linkStat':'0','orderStat':'0'},"
		+"{'colName':'chlPort','colText':'端口号','colWidth':'80px','linkStat':'0','orderStat':'0'},"
		+"{'colName':'chlTimeout','colText':'超时时间','colWidth':'80px','linkStat':'0','orderStat':'0'},"
		+"{'colName':'chlStat','colText':'状态','colWidth':'80px','linkStat':'0','orderStat':'0'},"
		+"{'colName':'creTime','colText':'提交时间','colWidth':'150px;','linkStat':'0','orderStat':'0'}"
		+"]}}}";
	pageinfo.crumbString = "渠道管理,渠道配置";
</script>
