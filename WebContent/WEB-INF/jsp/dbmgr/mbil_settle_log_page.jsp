...
<script type="text/javascript">
	...
	pageinfo.pageUrl = "/<%=WebConfig.getProperty("web.path")%>/dbmgr/mbilsettlelog/page.json/all";
	pageinfo.styleJson = "{'pStyle':{'tableStyle':{'tableCol':[{'colName':'slUid','colText':'交易用户','colWidth':'60px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'slOrderid','colText':'订单编号','colWidth':'150px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'slTranid','colText':'交易流水','colWidth':'100px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'slFeecode','colText':'费率类型','colWidth':'60px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'slSettleCode','colText':'结算类型','colWidth':'60px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'slTranvalue','colText':'交易金额','colWidth':'60px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'slSettlevalue','colText':'结算金额','colWidth':'60px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'slTrantime','colText':'交易时间','colWidth':'60px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'slSettletime','colText':'清算时间','colWidth':'60px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'slStat','colText':'清算状态','colWidth':'60px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'creTime','colText':'创建时间','colWidth':'100px;','linkStat':'0','orderStat':'0'}]}}}";
