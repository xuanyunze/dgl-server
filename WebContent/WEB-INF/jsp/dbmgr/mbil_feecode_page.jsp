...
<script type="text/javascript">
	...
	pageinfo.pageUrl = "/<%=WebConfig.getProperty("web.path")%>/dbmgr/mbilfeecode/page.json/all";
	pageinfo.styleJson = "{'pStyle':{'tableStyle':{'tableCol':[{'colName':'fcId','colText':'费率编号','colWidth':'60px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'fcName','colText':'费率名称','colWidth':'150px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'fcRate','colText':'费率值','colWidth':'100px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'fcIstop','colText':'是否封顶','colWidth':'80px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'fcTopvalue','colText':'封顶值','colWidth':'80px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'fcStat','colText':'状态','colWidth':'80px;','linkStat':'0','orderStat':'0'},"
