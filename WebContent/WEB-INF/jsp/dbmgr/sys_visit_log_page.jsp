...
<script type="text/javascript">
	...
	pageinfo.pageUrl = "/<%=WebConfig.getProperty("web.path")%>/dbmgr/sysvisitlog/page.json/all";
	pageinfo.styleJson = "{'pStyle':{'tableStyle':{'tableCol':[{'colName':'vlUid','colText':'访问用户','colWidth':'60px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'vlTime','colText':'访问时间','colWidth':'150px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'vlIp','colText':'来源地址','colWidth':'100px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'vlAction','colText':'访问动作','colWidth':'60px;','linkStat':'0','orderStat':'0'},"
