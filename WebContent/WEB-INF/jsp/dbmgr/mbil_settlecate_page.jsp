...
<script type="text/javascript">
	...
	pageinfo.pageUrl = "/<%=WebConfig.getProperty("web.path")%>/dbmgr/mbilsettlecate/page.json/all";
	pageinfo.styleJson = "{'pStyle':{'tableStyle':{'tableCol':[{'colName':'scId','colText':'类型编号','colWidth':'100px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'scName','colText':'清算名称','colWidth':'200px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'scRate','colText':'清算费率','colWidth':'150px;','linkStat':'0','orderStat':'0'},"
	                   +"{'colName':'scStat','colText':'状态','colWidth':'120px;','linkStat':'0','orderStat':'0'},"
